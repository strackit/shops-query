...
| `fetch failed`                      Network issue or GraphQL API is unreachable         
| `shopId: undefined`                      | `shopId` not passed to controller or test file      |
| `client is not defined`                  | Improper or missing import in queries/controllers   |
| `ERR_MODULE_NOT_FOUND`                   | Incorrect path while importing modules              |
