  ...
  //  Wishlist
  {
    ...
    execute: async () => {
      if (graphqlModules.wishlist?.fetchWishlist) {
        ...
        console.warn(' fetchWishlist not found');
      }
    },
  },
  {
  ...
  },
  {
    ...
    execute: async () => {
      if (graphqlModules.wishlist?.removeFromWishlist) {
        ...
        console.warn(' removeFromWishlist not found');
      }
    },
  },
  ...
  // ✅ Product Reviews
  {
    ...
    execute: async () => {
      if (graphqlModules.productReviews?.getProductReviewsController) {
        ...
        console.warn(' getProductReviewsController not found');
      }
    },
  },
  {
    ...
    execute: async () => {
      if (graphqlModules.productReviews?.addReviewController) {
        ...
        console.warn(' addReviewController not found');
      }
    },
  },
  {
    ...
    execute: async () => {
      if (graphqlModules.productReviews?.editReviewController) {
        ...
        console.warn(' editReviewController not found');
      }
    },
  },
  ...
  //  Order Updates Listener
  {
    ...
    execute: async () => {
      if (graphqlModules.orderUpdates?.listenToOrderUpdatesController) {
        ...
        console.warn(' listenToOrderUpdatesController not found');
      }
    },
  },
];
