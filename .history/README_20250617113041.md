...
npm init -y  --- To create a package.json file in the project to initialize the project

npm install --save graphql graphql-tools graphql-tag  --- To install the graphql dependencies

npm install dotenv --save  --- To install the dotenv dependencies for creating an environment for the client to connect to the server.

node test.js  --- To run the test file to make sure everything is working fine.