...
- Uses `graphql-request` as GraphQL client for simplicity.
- Modular architecture for clarity and reuse.
- Add your actual product/shop/user/test data to test endpoints meaningfully.
- Ensure `.env` is set up before testing.
