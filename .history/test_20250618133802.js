...
async function runAllTests() {
  ...
  try {
    ...
    console.log('\n🔹 Wishlist - Fetch');
    console.log(await gm.wishlist.getWishlistController({ userId:1 }));

    console.log('\n🔹 Wishlist - Add');
await gm.wishlist.addToWishlistController({ userId: 1, productId: 3128, shopId: 12 , id: 4617});

console.log('\n🔹 Wishlist - Remove');
console.log(await gm.wishlist.removeFromWishlistController({ userId: 1, productId: 3128, shopId: 12, id:4617 }));
