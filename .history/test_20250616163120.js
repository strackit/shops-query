...
async function runAllTests() {
  ...
  try {
    ...
    console.log('\n🔹 Master Categories');
    console.log(await gm.masterCategories.getMasterCategoriesController());
    ...
    console.log('\n🔹 Cart - Remove');
    console.log(await gm.cart.removeFromCart({ productId: 1, shopId: 1, userId: 1, update: false, quantity: 1 }));

    console.log('\n🔹 Wishlist - Fetch');
    console.log(await gm.wishlist.getWishlistController({ userId: 1 }));

    console.log('\n🔹 Wishlist - Add');
    console.log(await gm.wishlist.addToWishlistController(1, 1, 1)); // productId, shopId, userId

    console.log('\n🔹 Wishlist - Remove');
    console.log(await gm.wishlist.removeFromWishlistController({ userId: 1, productId: 1, shopId: 1 }));
