...
const PRODUCTS_BY_CATEGORY_QUERY = require('../queries/productsByCategory.js');
...
const ADD_REVIEW_MUTATION = require('../mutations/ratings.js').ADD_REVIEW_MUTATION;
const EDIT_REVIEW_MUTATION = require('../mutations/ratings.js').EDIT_REVIEW_MUTATION;
