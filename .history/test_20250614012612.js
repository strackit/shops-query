  ...
  // ✅ Products
  {
    ...
    execute: async () => {
      if (graphqlModules.products?.getProductsController) {
        ...
        console.warn('⚠️ getProductsController not found');
      }
    },
  },
  {
    ...
    execute: async () => {
      if (graphqlModules.products?.updateProductController) {
        ...
        console.warn('⚠️ updateProductController not found');
      }
    },
  },
  ...
  // ✅ Cart
  {
    ...
    execute: async () => {
      if (graphqlModules.cart?.fetchCart) {
        ...
        console.warn('⚠️ fetchCart not found');
      }
    },
  },
  {
  ...
  },
  {
    ...
    execute: async () => {
      if (graphqlModules.cart?.removeFromCart) {
        ...
        console.warn('⚠️ removeFromCart not found');
      }
    },
  },
