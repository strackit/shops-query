...
import productReviews from './productReviews/index.js';
import productByFilters from './productByFilters/index.js';
import productByCategory from './productByCategory/index.js';
import topProducts from './topProducts/index.js';
import offerProducts from './offerProducts/index.js';
import productByPrice from './productByPrice/index.js';
import searchProducts from './searchproducts/index.js';
import wishlist from './wishlist/index.js';
import cart from './cart/index.js';
import orderUpdates from './orderUpdates/index.js';
import categories from './categories/index.js';
import masterCategories from './masterCategories/index.js';
import nestedCategory from './nestedCategory/index.js';
