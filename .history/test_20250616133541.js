...
import { testProducts } from './test/products.test.js';

import { wishlistFetchTest } from './test/wishlist-fetch.test.js';
import { wishlistAddRemoveTest } from './test/wishlist-add-remove.test.js';

import { testTopProducts } from './test/topProducts.test.js';
import { testProductsByCategory } from './test/productsByCategory.test.js';
import { testProductByPrice } from './test/productByPrice.test.js';
import { testSearchProducts } from './test/searchProducts.test.js';

import { testOrderUpdates } from './test/orderUpdates.test.js';
