...
async function runAllTests() {
  ...
  try {
    ...
    console.log('\n🔹 Cart - Add');
    console.log(await gm.cart.addToCart({ productId: 7660, shopId: 348, userId: null, quantity: 2 }));

    console.log('\n🔹 Cart - Fetch');
    console.log(await gm.cart.fetchCart(1));

    console.log('\n🔹 Cart - Remove');
    console.log(await gm.cart.removeFromCart({ productId: 7660, shopId: 348, userId: null, update: false, quantity: 6 }));

    console.log('\n🔹 Wishlist - Fetch');
    console.log(await gm.wishlist.getWishlistController({ userId: null }));

    console.log('\n🔹 Wishlist - Add');
    console.log(await gm.wishlist.addToWishlistController(7660, 348, null)); // productId, shopId, userId

    console.log('\n🔹 Wishlist - Remove');
    console.log(await gm.wishlist.removeFromWishlistController({ userId: null, productId: 7660, shopId: 348 }));
